// Version 1: Focused Cursor Light
import React, { useMemo, useRef, useState, useEffect } from "react";

const inlinedStyles = `
  /* --- Reactive Background Styles (MODIFIED) --- */
  .reactive-background {
    position: fixed;
    top: 0;
    left: 0;
  ...
  /* CHANGE: Gradient size reduced to 300px and fade-out sharpened to 50% */
  .light .reactive-background {
    background: radial-gradient(
      300px circle at var(--mouse-x) var(--mouse-y),
      rgba(199, 183, 224, 0.35),
      transparent 50%
    );
  }

  /* CHANGE: Gradient size reduced to 400px and fade-out sharpened to 40% */
  ...
  return (
    <>
      ...
      <div className={`relative min-h-screen transition-all duration-500 ${darkMode ? 'dark' : 'light'} ${
        ...
        <header className={`relative z-10 backdrop-blur-sm border-b ${
          darkMode 
          ...
          <div className="max-w-6xl mx-auto px-6 py-4">
            <div className="flex items-center justify-between">
              ...
              <button
                ...
                } backdrop-blur-md border border-gray-300/20`}
              >
